...
\begin{figure}
	\includegraphics[width=0.8\linewidth]{{temp N-1e5.72 dx-0.05 t-100 dt-0.001 ic-hotplanck c-0.0010 Z-1.0500 brems}.pdf}
	\caption{Profile of effective temperature (comparing with Planckian} as in Fig.~\ref{fig:spd-c}
	}\label{fig:T}
\end{figure}

Fig.~\ref{fig:T} plots the effective temperature as function of frequenct=y by comparing with a Planckian.
