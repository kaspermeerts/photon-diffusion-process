...
\begin{figure}
	...
	\caption{Profile of effective temperature (comparing with Planckian) as in 
	Fig.~\ref{fig:spd-c} }\label{fig:T}
\end{figure}

Fig.~\ref{fig:T} plots the effective temperature as function of frequency by 
comparing with a Planckian.
